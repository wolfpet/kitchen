...
<?php if ($logged_in) { ?>
      ...
      ?>      
			<span id="Logout" class="ribbonIcon tooltip"><a target="contents" href="<?=$url?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M7 8V5l-7 7 7 7v-3l-4-4 4-4zm6 1V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z"></path></g></svg></a>
