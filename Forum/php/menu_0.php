...
<?php if (isset($title) && $title != null) { ?>
	<div id="ForumTitle" class="ribbonGroup"; style="width: 100px;height: 44px;padding-top: 10px;text-align: center;vertical-align: top; font-size: x-large;padding-top: 11;">
<?php if (isset($banner) && !is_null($banner)) { ?>
<img src="<?=$banner?>" alt="<?='Welcome'?>"/>
<?php } else { print($title); }?>
</div>
<?php }?>
	<div id="SortRibbonGroup" class="ribbonGroupMobile";">
		...
		<div id="SortRibbonGroupIconContainer">
			<span class="ribbonIcon tooltip" id="ByDateIcon"><a target="contents" href="<?=$root_dir.$page_bydate?>?mode=bydate">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path class="ribbonIcon" fill="white" d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"></path></g></svg>
			...
			<span id="Expanded" class="ribbonIcon tooltip"><a target="contents" href="<?=$root_dir.$page_expanded?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M6 7h2.5L5 3.5 1.5 7H4v10H1.5L5 20.5 8.5 17H6V7zm4-2v2h12V5H10zm0 14h12v-2H10v2zm0-6h12v-2H10v2z"></path></g></svg>
			...
			<span id="Collapsed" class="ribbonIcon tooltip"><a target="contents" href="<?=$root_dir.$page_collapsed?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M4 10.5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm0-6c-.83 0-1.5.67-1.5 1.5S3.17 7.5 4 7.5 5.5 6.83 5.5 6 4.83 4.5 4 4.5zm0 12.17c-.74 0-1.33.6-1.33 1.33s.6 1.33 1.33 1.33 1.33-.6 1.33-1.33-.59-1.33-1.33-1.33zM7 19h14v-2H7v2zm0-6h14v-2H7v2zm0-8v2h14V5H7z"></path></g></svg>
				<span class="tooltiptext">Collapsed</span></a>
			</span> 
		</div>
	</div>
	<div id="WriteRibbonGroup" class="ribbonGroupMobile">
	...
	<div id="FindRibbonGroup" class="ribbonGroup">
		...
		<div id="FindRibbonGroupIconContainer">
			...
			<span id="Search" class="ribbonIcon tooltip"><a target="bottom" href="<?=$root_dir.$page_search . (strcmp($cur_page, $page_my_bookmarks) == 0 ? "?mode=bookmarks" : "")?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path></g></svg>
				<span class="tooltiptext">Search</span></a>
			</span> 
		</div>
	</div>

	<div id="ViewRibbonGroup" class="ribbonGroup";>
		...
		<div id="ViewRibbonGroupIconContainer">
			<span id="Horizontal" class="ribbonIcon tooltip"><a target="_top" href=".">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M4 18h17v-6H4v6zM4 5v6h17V5H4z"></path></g></svg>
				<span class="tooltiptext">Horizontal</span></a>
			</span> 
			<span id="Vertical" class="ribbonIcon tooltip"><a target="_top" href="cols.html">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M6 5H3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1zm14 0h-3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1zm-7 0h-3c-.55 0-1 .45-1 1v12c0 .55.45 1 1 1h3c.55 0 1-.45 1-1V6c0-.55-.45-1-1-1z"></path></g></svg>
				<span class="tooltiptext">Vertical</span></a>
			</span> 
			<span id="Phone" class="ribbonIcon tooltip"><a target="_top" href="mobile/index.html">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M20.1 7.7l-1 1c1.8 1.8 1.8 4.6 0 6.5l1 1c2.5-2.3 2.5-6.1 0-8.5zM18 9.8l-1 1c.5.7.5 1.6 0 2.3l1 1c1.2-1.2 1.2-3 0-4.3zM14 1H4c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2zm0 19H4V4h10v16z"></path></g></svg>
				<span class="tooltiptext">Phone</span></a>
			</span> 
			<span id="Refresh" class="ribbonIcon tooltip"><a target="contents" class="menu" href="<?php print($root_dir . $cur_page); if (!strcmp($cur_page, $page_byuser)) {print('?author_id=' . $author_id); }else {if (/*!strcmp($cur_page, $page_expanded) && */!is_null($page)){ print('?page=' . $page); } } ?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"></path></g></svg>
...
<?php if ($logged_in && !is_null($moder) && $moder > 0) {
  $regs = get_regs_count();
?>  
	<div id="ModRibbonGroup" class="ribbonGroup";>
		<div id="ViewRibbonGroupTitle1" class="ribbonGroupTitle" style="color: pink;";>Moderator</div>
		<div id="ViewRibbonGroupIconContainer">
<?php if ($regs > 0) { ?>
			<span id="Registrations" class="ribbonIcon tooltip"><a target="contents" href="<?=$root_dir.$page_registrations?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="pink" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path></g></svg>
...
<?php } ?>
			...
			<span id="DeletedPosts" class="ribbonIcon tooltip"><a target="contents" href="<?=$root_dir . $page_m_delposts?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="pink" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" class="style-scope iron-icon"></path></path></g></svg>
...
<?php } if ($logged_in == false) { ?>
	<div id="WelcomeRibbonGroup" class="ribbonGroup";>
		<div id="ViewRibbonGroupTitle1" class="ribbonGroupTitle">Welcome!</div>
		<div id="ViewRibbonGroupIconContainer">
			<span id="Login" class="ribbonIcon tooltip">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white"d="M12.65 10C11.83 7.67 9.61 6 7 6c-3.31 0-6 2.69-6 6s2.69 6 6 6c2.61 0 4.83-1.67 5.65-4H17v4h4v-4h2v-4H12.65zM7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"></path></g></svg>
				<span class="tooltiptext">Login</span>
			</span> 
			<span id="Register" class="ribbonIcon tooltip"><a target="bottom" href="<?=$root_dir . $page_new_user?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z" class="style-scope iron-icon"></path></g></svg>
			...
			<span id="ForgotPwd" class="ribbonIcon tooltip"><a target="bottom" href="<?=$root_dir . $page_forgot?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M17.01 14h-.8l-.27-.27c.98-1.14 1.57-2.61 1.57-4.23 0-3.59-2.91-6.5-6.5-6.5s-6.5 3-6.5 6.5H2l3.84 4 4.16-4H6.51C6.51 7 8.53 5 11.01 5s4.5 2.01 4.5 4.5c0 2.48-2.02 4.5-4.5 4.5-.65 0-1.26-.14-1.82-.38L7.71 15.1c.97.57 2.09.9 3.3.9 1.61 0 3.08-.59 4.22-1.57l.27.27v.79l5.01 4.99L22 19l-4.99-5z" class="style-scope iron-icon"></path></g></svg>
...
<?php if ($logged_in) { ?>
        ...
        <?php } ?>
			...
			<span id="Settings" class="ribbonIcon tooltip"><a target="bottom" href="<?=$root_dir.$page_profile?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path></g></svg>
      ...
      ?>      
			<span id="Logout" class="ribbonIcon tooltip"><a target="contents" href="<?=$url?>">
				<svg class="ribbonIcon"  viewBox="-3 0 30 25" preserveAspectRatio="xMidYMid meet"><g><path fill="white" d="M10.09 15.59L11.5 17l5-5-5-5-1.41 1.41L12.67 11H3v2h9.67l-2.58 2.59zM19 3H5c-1.11 0-2 .9-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" class="style-scope iron-icon"></path></g></svg></a>
