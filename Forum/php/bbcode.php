...
function before_bbcode($body) {
  ...
  $body = preg_replace( array (
    ...
    // imgur
    '#(?<!\[url(=|]))((?:https?://)?(?:www\.)?i\.imgur\.com/([^\s\.]*)\.?(?:[a-z]+)?(?:(?:\?|&)[^\s<\]"]*)?)#is'
    ), array (
    ...
    '<div class="imgur"><blockquote class="imgur-embed-pub" lang="en" data-id="$3"><a href="//imgur.com/$3">Direct Link</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script></div>'
    ), $body);    
