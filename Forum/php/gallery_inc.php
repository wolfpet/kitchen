...
<div class="gallery_container" id="gallery">
	...
	<div class="column-center">
	    <img src="https://teslamotorsclub.com/tmc/attachments/img_20161003_113644-1-jpg.197986/" style="
		width: 100%;
		margin: auto;
		display: block;
	    ">
	</div>
	<div class="column-left"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g><path id="gallery_nav_left" fill="#444" d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"></path></g></svg></div>
	<div class="column-right"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" style="pointer-events: none; display: block; width: 100%; height: 100%;"><g><path id="gallery_nav_right" fill="#444" d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"></path></g></svg></div>
	</div>
    <footer>Post title and the user name goes here</footer>
