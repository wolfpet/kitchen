...
<div class="overlay_container" id="overlay">
 <header><a id="overlay_title">TEST TITLE</a></header>
 <div>
	<div class="overlay_column_center">
	<!-- overlay content goes here -->
	<iframe id="overley_iframe" style="margin: auto;display: block;src=;width: 88%;height: 84vh;background-color: white;border: 1px;" src=""></iframe>
	</div>
 </div>
 ...
 <div id="overlay_menu" style="width: 100vw;position: absolute;top: 0px;color: white; opacity: 1.0;height: 53px;color: white; display: block">
    <div class="overlay_exit_btn_div" onclick="closeOverlay();" style="width: 30px; margin-right: 8px; margin-top: 8px; float: right;cursor: pointer;">
