...
--
-- Dumping routines for database 'confa'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`client`@`localhost` PROCEDURE `get_last_ids`(in u_id int, out max_id int, out last_id int)
...
-- Dump completed on 2017-06-15 20:47:09
